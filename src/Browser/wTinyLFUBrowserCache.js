...
import SLRUCache from "./wTinyLFU-SubCaches/slruSub-cache.js";
import LRUCache from "./wTinyLFU-SubCaches/lruSub-cache.js";
...
WTinyLFUCache.prototype.write = async function (
  queryStr,
  respObj,
  searchTerms,
  deleteFlag,
 ...
 *****/
WTinyLFUCache.prototype.TinyLFU = async function (
  WLRUCandidate,
  SLRUCandidate,
) {
